...
const debug = require('debug')('zero-to-one-common-bin');
const co = require('co');
...
// debug(this.version);
    ...
    if (context.argv.AUTO_COMPLETIONS) {
      ...
      this.yargs.getCompletion(this.rawArgv.slice(1), completions => {
       ...
       // handle by self
      // debug(context );
      debug('66666666666666666666666666666666666666666666666666666666');
       //debug(this.helper.callFn(this.run, [ context ], this));
