...
const debug = require('debug')('zero-to-one-bin:dev');
const Command = require('../command');
const path = require('path');
const utils = require('zero-to-one-utils');
...
debug('实例化Command开始');
  ...
  * run(context) {
    ...
    //debug('777777777777777777777777777777777777777777777');
    //debug(this.helper.forkNode(this.serverBin, devArgs, options));
